  ...
  return (
    <div className="w-full max-w-4xl mx-auto pt-4 pb-20 px-10">
      <section>
        ...
        <p className="text-base text-gray-600 leading-relaxed mb-6">
          You can find a list of casinos I&apos;ve played at and my thoughts on each {" "}
          <Link
            href="/poker/casinos"
        ...
        <p className="text-base text-gray-600 leading-relaxed">
          You can find out more about my poker journey, profitability, and tips to start for beginners {" "}
          <Link
            href="/poker/journey"
            className="text-gray-600 hover:text-indigo-600 underline decoration-gray-600 hover:decoration-indigo-600 underline-offset-2 transition-colors"
          >
