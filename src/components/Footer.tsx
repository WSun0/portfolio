export default function Footer() {
  return (
    <footer className="w-full border-t border-gray-200 py-8 text-center text-xs text-gray-500 bg-white/80 relative z-10">
      <div className="max-w-3xl mx-auto px-8 flex flex-col items-center gap-2">
        ...
        <div className="flex gap-6 mt-1">
          <a
            ...
            className="flex items-center gap-1 hover:underline hover:text-gray-700 transition px-2 py-1 cursor-pointer"
          ...
          >
            <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="inline-block align-middle">
              <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
